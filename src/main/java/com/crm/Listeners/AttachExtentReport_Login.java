...
public class AttachExtentReport_Login extends VE3_Base implements ITestListener
{
	...
	public void onTestSuccess(ITestResult result) {
		// TODO Auto-generated method stub
		String name = result.getMethod().getMethodName();
		test.log(Status.PASS, name+" Login test_script is pass");
	...
	public void onStart(ITestContext context) {
		// TODO Auto-generated method stub
		File path=new File(".\\src\\test\\resources\\Reports\\Do_Login.html");
